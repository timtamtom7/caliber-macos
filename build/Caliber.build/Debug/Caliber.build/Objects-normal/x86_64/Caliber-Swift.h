...
#ifndef CALIBER_SWIFT_H
#define CALIBER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Caliber",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Caliber11AppDelegate")
...
@class NSEvent;
@class NSCoder;
SWIFT_CLASS("_TtC7Caliber22MeasurementOverlayView")
@interface MeasurementOverlayView : NSView
...
SWIFT_CLASS("_TtC7Caliber24MeasurementOverlayWindow")
@interface MeasurementOverlayWindow : NSWindow
